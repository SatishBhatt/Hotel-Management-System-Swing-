...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Change Name and Password");
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, 0, 1100, 600));
...
// TODO add your handling code here:
    ...
    //******************here if the admin name and pasword match with the database ,******
    //***************then jump to home otherwise invalid massege appears*********   
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/desktophotel","root","");
            
            PreparedStatement ps = con.prepareStatement("Select * from info where admin = ? and adminPassword = ?");
            ...
            {
                JOptionPane.showMessageDialog(this, "invalid Name and Password");
            }
